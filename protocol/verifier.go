...
func (v *Verifier) VerifyMembership(root fr.Element, commitment bls12381.G1Affine, proof []fr.Element, idx int, depth int) bool {
...
func (v *Verifier) VerifyMembershipWithMeta(root fr.Element, commitment bls12381.G1Affine, meta crypto.MerkleLeafMeta, proof []fr.Element, idx int, depth int) bool {
...
func (v *Verifier) VerifyMultiMembership(root fr.Element, commitments []bls12381.G1Affine, indices []int, proof crypto.MerkleMultiProof, depth int) bool {
...
func (v *Verifier) VerifyMultiMembershipWithMeta(root fr.Element, commitments []bls12381.G1Affine, metas []crypto.MerkleLeafMeta, indices []int, proof crypto.MerkleMultiProof, depth int) bool {
