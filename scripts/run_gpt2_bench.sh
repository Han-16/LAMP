...
usage() {
	...
	echo "" >&2
	echo "examples:" >&2
	echo "  sh scripts/run_gpt2_bench.sh lamp --seq 1 --rho 1/2 --L 1 --linker qa_nizk --merkle multi" >&2
	echo "  sh scripts/run_gpt2_bench.sh lamp --seq 1 --rho 1/2 --L 1 --linker qa_batch --merkle multi" >&2
...
for key in \
	LAMP_GPT2_SEQ LAMP_GPT2_RHO LAMP_GPT2_L LAMP_GPT2_LINKER LAMP_GPT2_MERKLE LAMP_GPT2_ALL LAMP_GPT2_SEQ_FROM LAMP_GPT2_SEQ_TO LAMP_GPT2_ONLY_COMPILE LAMP_GPT2_OUTPUT_DIR \
